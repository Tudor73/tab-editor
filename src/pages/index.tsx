...
export default function Home() {
  ...
  const handleSaveFile = () => {
    ...
    fetch("http://localhost:5000/save", {
      method: "POST",
      body: JSON.stringify({ tab: tabState, fileName: fileName, username: username, songName: songName }),
      headers: {
  ...
  return (
    <div className="flex flex-col items-center mt-20 ">
      ...
      <div className={"px-4" + (editMode ? " border-2 border-solid border-red-400" : "")}>
        ...
        {renderTab && <input type="text" value={username} onChange={(e) => {
        ...
        {renderTab && (
          <div className="py-4">
            ...
            {!editMode && (
              <button className="bg-green-300 px-4 py-2 rounded-lg ml-2" onClick={handleSaveFile}>
                Save
              </button>
            )}
          </div>
